...
ggplot(big_pairs, aes(x=fantasyPts.x, y=fantasyPts.y, alpha=.4)) +
  ...
  scale_size(range=c(1,3)) +
  geom_smooth(method="loess") +
  labs(title="Year-End Points by Fantasy Points within Consecutive Games (TE)", x="Fantasy Points within consecutive games", y="Year-End Fantasy Points")

ggplot(big_pairs, aes(fantasyPts.x, fill="darkorchid4")) +
  geom_histogram() +
  geom_vline(xintercept=7.5, linetype="dashed", color="black", linewidth=1) +
  labs(title="Fantasy Points within Consecutive Games Distribution (TE)", x="Fantasy Points within consecutive games", y="", fill="")
```
