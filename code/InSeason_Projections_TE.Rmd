...
Thankfully, the more complex models (backwards stepwise regression) that use more variables are also significantly different in predictive power (all under 0.0001 p values) compared to the models that only use average fantasy points.
